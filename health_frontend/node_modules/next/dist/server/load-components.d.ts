...
import type { PageConfig, GetStaticPaths, GetServerSideProps, GetStaticProps } from 'next/dist/types';
...
declare function loadComponentsImpl<N = any>({ distDir, page, isAppPath, isDev, sriEnabled, needsManifestsForLegacyReasons, }: {
    distDir: string;
    page: string;
    isAppPath: boolean;
    isDev: boolean;
