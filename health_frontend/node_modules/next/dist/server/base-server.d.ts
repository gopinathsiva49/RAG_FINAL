...
import type { RenderOptsPartial as AppRenderOptsPartial, ServerOnInstrumentationRequestError } from 'next/dist/server/app-render/types';
import type { ServerComponentsHmrCache, ResponseCacheBase } from 'next/dist/server/response-cache';
